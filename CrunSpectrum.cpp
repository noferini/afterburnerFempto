...
void runSpectrum::initHistos()
{
    ...
    mHProtonSpectrumM = new TH1D("mHProtonSpectrumM" + mName, "Spectrum;p_{T}/M", 100, 0., 10.);
    mHNeutronSpectrumM = new TH1D("mHNeutronSpectrumM" + mName, "Spectrum;p_{T}/M", 100, 0., 10.);
    mHDeuteronSpectrumM = new TH1D("mHDeuteronSpectrumM" + mName, "Spectrum;p_{T}/M", 100, 0., 10.);
    mHTritiumSpectrumM = new TH1D("mHTritiumSpectrumM" + mName, "Spectrum;p_{T}/M", 100, 0., 10.);
    mHHelium3SpectrumM = new TH1D("mHHelium3SpectrumM" + mName, "Spectrum;p_{T}/M", 100, 0., 10.);
    mHHelium4SpectrumM = new TH1D("mHHelium4SpectrumM" + mName, "Spectrum;p_{T}/M", 100, 0., 10.);
    ...
    mHAntiProtonSpectrumM = new TH1D("mHAntiProtonSpectrumM" + mName, "Spectrum;p_{T}/M", 100, 0., 10.);
    mHAntiNeutronSpectrumM = new TH1D("mHAntiNeutronSpectrumM" + mName, "Spectrum;p_{T}/M", 100, 0., 10.);
    mHAntiDeuteronSpectrumM = new TH1D("mHAntiDeuteronSpectrumM" + mName, "Spectrum;p_{T}/M", 100, 0., 10.);
    mHAntiTritiumSpectrumM = new TH1D("mHAntiTritiumSpectrumM" + mName, "Spectrum;p_{T}/M", 100, 0., 10.);
    mHAntiHelium3SpectrumM = new TH1D("mHAntiHelium3SpectrumM" + mName, "Spectrum;p_{T}/M", 100, 0., 10.);
    mHAntiHelium4SpectrumM = new TH1D("mHAntiHelium4SpectrumM" + mName, "Spectrum;p_{T}/M", 100, 0., 10.);
